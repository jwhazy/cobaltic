...
function Titlebar() {
  ...
  return (
    <header
      ...
      className="  flex justify-between backdrop-filter backdrop-blur-3xl top-0 z-50 drag h-8 sticky bg-black bg-opacity-25 w-screen flex-shrink-0 overflow-hidden"
    >
      <div className="flex flex-row no-drag">
        {state !== State.UPDATE_READY ? (
          <TitlebarItem onClick={() => navigate("/")}>
            <p className="font-black text-lg pl-2">
